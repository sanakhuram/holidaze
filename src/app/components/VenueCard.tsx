...
export default function VenueCard({ venue }: { venue: Venue }) {
  ...
  return (
    <Link
      ...
      className="group block shadow-xl  rounded-md transition 
    ...
    >
      <div className="relative h-48 w-full overflow-hidden">
        <SafeImage
          ...
          className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.03] rounded-md"
        />
      </div>
      ...
      <div className="bg-background px-4 py-4 sm:px-5 sm:py-5 rounded-md">
