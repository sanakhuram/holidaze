    ...
    <CollapsibleSection title="Hosting Guide">
      <div className="space-y-3 text-sm leading-relaxed text-slate-700">
        ...
        <ol className="list-inside list-decimal space-y-1">
          ...
          <li>
            <strong>Photos:</strong> Upload clear, high-quality images that show off your venue.
          </li>
          <li>
            <strong>Pricing & Guests:</strong> Set a nightly price and max guest capacity.
          </li>
          <li>
            <strong>Amenities:</strong> Highlight what makes your venue special (Wi-Fi, parking,
            breakfast, etc.).
          </li>
        </ol>
        <p>
